...
После первой синхронизации будут созданы жанры фильмов Start. Затем необходимо выполнить финальный шаг:

* Создать требуемые жанры видеотеки в Smarty и произвести маппинг жанров Start к жанрам Smarty в служебной панели администратора
  по адресу http://smarty.example.com/admin/cinema_start/startgenremap/.
